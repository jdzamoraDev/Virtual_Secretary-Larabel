...
<body>
        ...
        <div class="container my-5 text-center" id="">
        <div class="row">
          <div class="col-lg-6">
            <div class="widget-next-match">
              ...
              <h4 class="text-white">Encargado:</h4>
                <h4>Luis Jesus Pereza</h4>
                <p class="mb-5">

                </p>

                <!-- Button for choose the game -->
                <a class="btn btn-dark btn-m" href="contactForm">
                            <i class="bi bi-envelope"></i>
                            </a>

                            <a class="btn btn-dark btn-m" href="https://wa.me/+50685624469?text=Hello%20I%20Have%20a%20question%20about%20coding">
                            <i class="bi bi-whatsapp"></i>
                            </a>

                            <a class="btn btn-dark btn-m" href="tel:123-456-7890">
